    ...
    const render =useMemo(()=>{
        if(cicrle){
            return(
                ...
                viewBox="0 0 420 420" style={{transform:'rotate(270deg)'}}>
                    <circle
                    cx="210" cy="210" r="170" strokeWidth="40" stroke="#f5f5f5" fill="none"></circle>
                    <circle cx="210" cy="210" r="170" strokeWidth="40" stroke="#40a9ff" fill="none"
                    opacity={state===0?0:1}
                        strokeLinecap='round'
                ...
                <div className='bigbear-progress-circle-inner'
                    style={{lineHeight:`${size!*0.62}px`,width:`${size!*0.62}px`,height:`${size!*0.62}px`}}
                >
            ...
            return(
                ...
                {countNumber&&<div className="bigbear-progress-number" 
                style={{lineHeight:`${height?height:8}px`}}>{progressText?progressText:`${state}%`}</div>}
            </div>
            )
        }
