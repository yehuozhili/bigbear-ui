    ...
    return(
        ...
        <Modal setState={setState} visible={state} confirm={false}  >
            ...
            <div style={{display:'flex',justifyContent:'flex-end'}}>
                <Button btnType="primary" onClick={()=>setState(false)}>自定义ok</Button>
                <Button btnType='info'  onClick={()=>setState(false)}>自定义取消</Button>
            </div>
        </Modal>
...
export function ModalExample5(){
    ...
    return(
        <div>
        <Modal title={<p><Icon icon={'info-circle'}></Icon>带上图标标题</p>} setState={setState} visible={state}  style={{top:'40px',width:'800px'}} closeButton={false}	  >
            <p>balabalabala</p>
            <p>balabalabalalalalallaa</p>
        </Modal>
